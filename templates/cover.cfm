  ...
  <head>
    ...
    <style>
      ...
      */
      ...
      body##cover {
        background-image: url('#$.siteConfig('themeAssetPath')#/images/galaxy-3608029_1920.jpg') !important
      }
    </style>
  </head>
  <body id="cover" class="d-flex h-100 text-center text-bg-dark">
    ...
    <div>
      ...
      <cfif i.hasNext()>
        <cfloop condition="i.hasNext()">
          ...
          <a href="#item.getUrl()#" class="nav-link fw-bold py-1 px-0">#item.getMenuTitle()#</a>
          <cfelse>
          <a href="#item.getUrl()#" class="nav-link fw-bold py-1 px-0 active">#item.getMenuTitle()#</a>
          </cfif>
        </cfloop>
      </cfif>
      </nav>
